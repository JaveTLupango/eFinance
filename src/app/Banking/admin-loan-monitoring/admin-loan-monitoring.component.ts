...
@Component({
  selector: 'app-admin-loan-monitoring',
  templateUrl: './admin-loan-monitoring.component.html',
  styleUrls: ['./admin-loan-monitoring.component.css']
})
export class AdminLoanMonitoringComponent {
